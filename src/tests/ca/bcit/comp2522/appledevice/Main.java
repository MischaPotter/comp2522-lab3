...
public class Main
{
    ...
    public static void main(final String[] args)
    {
        ...
        final IPhone17 iphone16_1;
        final IPhone17 iphone16_2;
        final IPhone17 iphone16_3;

        iphone16_1 = new IPhone17(100.0, "Verizon", true, 512); // 100 minutes, high-res camera, 512 GB
        iphone16_2 = new IPhone17(100.0, "Verizon", true, 256); // 100 minutes, high-res camera, 256 GB
        iphone16_3 = new IPhone17(100.0, "Verizon", false, 512); // 100 minutes, no high-res camera, 512 GB
